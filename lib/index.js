define(['lang', 'engine/core', 'components/keyboardControls'], function(lang, engine, controls){
  ...
  game.listen("startup", function(){
    controls.init();
    // TODO: remove, 
    //    keyboard state is provided to all entities with the keyboardControls component attached
    //    a entity.keysDown keys map is updated during beforeUpdate
